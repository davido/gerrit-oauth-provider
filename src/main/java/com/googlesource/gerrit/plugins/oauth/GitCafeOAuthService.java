...
@Singleton
class GitCafeOAuthService implements OAuthServiceProvider {
  private static final Logger log =
      LoggerFactory.getLogger(GitCafeOAuthService.class);
  static final String CONFIG_SUFFIX = "-gitcafe-oauth";
  private static final String PROTECTED_RESOURCE_URL =
      "https://api.gitcafe.com/api/v1/user";

  private static final String SCOPE = "read";
  private final OAuthService service;

  @Inject
  GitCafeOAuthService(PluginConfigFactory cfgFactory,
  ...
  public OAuthUserInfo getUserInfo(OAuthToken token) throws IOException {
    ...
    if (userJson.isJsonObject()) {
      ...
      return new OAuthUserInfo(id.getAsString(),
          ...
          fullname == null || fullname.isJsonNull() ? null : fullname.getAsString(),
          null);
    } else {
        throw new IOException(String.format(
