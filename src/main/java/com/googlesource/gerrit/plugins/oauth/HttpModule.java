...
class HttpModule extends HttpPluginModule {
  ...
  protected void configureServlets() {
    PluginConfig cfg = cfgFactory
        .getFromGerritConfig(pluginName + GoogleOAuthService.CONFIG_SUFFIX);
    ...
    cfg = cfgFactory
        .getFromGerritConfig(pluginName + GitHubOAuthService.CONFIG_SUFFIX);
    ...
    cfg = cfgFactory
        .getFromGerritConfig(pluginName + BitbucketOAuthService.CONFIG_SUFFIX);
    if (cfg.getString("client-id") != null) {
      bind(OAuthServiceProvider.class)
