...
The client-id and client-secret for AirVantage OAuth can be optained by registering
a Client application.
Cf [Getting Started](https://source.sierrawireless.com/airvantage/av/howto/cloud/gettingstarted_api).
